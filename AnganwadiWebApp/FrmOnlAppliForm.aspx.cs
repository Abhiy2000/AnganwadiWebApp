...
{
    public partial class FrmOnlAppliForm : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                LblGrdHead.Text = "Online Application Form";
                Session["GrdLevel"] = 11;
                Session["UserId"] = "Citizen";
                filldropdwon();
            }
            else
            {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (obj.ErrorCode == 9999)
            {
                ...
                MessageAlert(obj.ErrorMsg, "FrmOnlAppliForm.aspx");
                return;
            }
            else
            {
        ...
        protected void validationcontrols()
        {
            ...
            Int64 age = Convert.ToInt64(txtage.Text);

            if (age < 18)
            {
                MessageAlert("Age must be greater than 18", "");
                txtage.Focus();
                return;
            }
        ...
        {
            DateTime birthDate = Convert.ToDateTime(birthdt.Value); // call to your uc1:Date exposed property
            Int64 age = CalculateAge(birthDate);
        ...
        private int CalculateAge(DateTime birthDate)
        {
            ...
            if (birthDate > today.AddYears(-age)) age--; // adjust for birth date not yet reached
            return age;
        }
    }
}