...
{
    public partial class FrmResetPwdList : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void GrdUserList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Admin/FrmResetPwdMst.aspx");
        }
        ...
        protected void LoadGrid()
        {
            try
            {
                ...
                if (TblUserDet.Rows.Count > 0)
                {
                    ...
                    QueryGetList += " inner join companyview br on br.brid = um.num_usermst_brid  ";
                    QueryGetList += " where br.hoid=" + HOID;
                    QueryGetList += " and br.brid=" + Session["GrdLevel"];//----------------18-04-18
