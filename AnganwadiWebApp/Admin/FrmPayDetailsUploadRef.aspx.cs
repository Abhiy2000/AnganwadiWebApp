...
{
    public partial class FrmPayDetailsUploadRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Admin/FrmPayDetailsUpload.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Admin" + " >> " + "Upload Payment Details ";                 //---- Label Heading : Master Name ---//
