<%@ Page Title="User Creation" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmUserList.aspx.cs" Inherits="ProjectManagement.User.FrmUserList" %>
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            ...
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="GrdUserList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            OnSelectedIndexChanged="GrdUserList_SelectedIndexChanged">
