<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmCDPOmodifyScreen.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmCDPOmodifyScreen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="boxHead">
        <asp:Label ID="LblGrdHead" runat="server" Font-Size="Medium">Transaction >> CDPO Screen </asp:Label>
    </div>
    <br />
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridCdpoScrn" runat="server" AutoGenerateColumns="false" AllowPaging="true" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataText="No Records Found!" ShowHeaderWhenEmpty="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Doc.Download" HeaderStyle-Width="15%">
                                    <ItemTemplate>
                                        <p>
                                            DOB : 
