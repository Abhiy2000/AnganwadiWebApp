<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmLICApproval.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmLICApproval" %>
    ...
    <div class="Panel" style="width: 1125px; height: 500px; overflow: auto">
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="conditional" ChildrenAsTriggers="false">
                ...
                <ContentTemplate>
                    <asp:GridView ID="grdLICDEF" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        PageSize="10" CssClass="Grid" Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Download Image" ItemStyle-Width="6%">
                            <ItemTemplate>
                             ...
                             <asp:HiddenField ID="ImagDoc" runat="server" Value='<%# Bind("DocImage") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
        ...
        <div>
            <asp:ImageButton ID="BigDocImg" runat="server" Height="300px" Width="300px" BorderWidth="1px"
                BorderColor="Black" BorderStyle="Solid" Style="display: none;
                float: right;" />
        </div>
