...
{
    public partial class FrmSevikaAuthRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmSevikaAuthList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Authorized Sevika";                            //---- Label Heading : Master Name ---//
