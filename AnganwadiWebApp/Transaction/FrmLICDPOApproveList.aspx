<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmLICDPOApproveList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmLICDPOApproveList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="height: 500px; width: 1150px; overflow: auto;">
        ...
        <br />
        <br />
        <asp:Panel ID="PnlSerch" runat="server" Style="height: 500px; width: 100%;">
            <div>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="conditional" ChildrenAsTriggers="false">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdLICDEF" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="grdLICDEF_PageIndexChanging"
                            PageSize="10" CssClass="Grid" Width="80%">
                            <Columns>

                                <%--<asp:CommandField SelectText="Download" ShowSelectButton="true" HeaderText="View Document" />--%>
                                ...
                                <%--<asp:BoundField DataField="SevikaID" HeaderText="SevikaID" Visible="false" />--%>
                                ...
                                <asp:TemplateField HeaderText="Reject Reason" HeaderStyle-HorizontalAlign="Center">
                                    <ItemStyle HorizontalAlign="left" />
                                    <ItemTemplate>
