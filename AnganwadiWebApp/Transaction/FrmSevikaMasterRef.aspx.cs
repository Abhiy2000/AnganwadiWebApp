...
{
    public partial class FrmSevikaMasterRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmSevikaMasterList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Sevika Master";                            //---- Label Heading : Master Name ---//
