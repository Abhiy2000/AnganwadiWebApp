...
{
    public partial class FrmCDPOmodifyScreenRef : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String MenuRights = MstMethods.ChkRights(Session["UserId"].ToString(), "../Transaction/FrmCDPOmodifyScreenRef.aspx");
            ...
            Session["BrToList"] = "../Transaction/FrmCDPOmodifyScreen.aspx";    //---- To Redirect Transaction MainList ---//
            Session["LblGrdHead"] = "Transaction >> CDPO Screen ";                 //---- Label Heading : Master Name ---//
