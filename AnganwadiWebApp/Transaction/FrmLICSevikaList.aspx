...
AutoEventWireup="true" CodeBehind="FrmLICSevikaList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmLICSevikaList" %>
                    ...
                    <td class="style1">
                        <asp:GridView ID="GrdSevikaList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="num_licsevika_sevikaid" HeaderText="Sevika ID">
                                    <HeaderStyle Width="200px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="var_angnwadimst_angnname" HeaderText="Anganwadi">
                                    <HeaderStyle Width="200px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="num_licsevika_anganid" HeaderText="Angan Id" />
                                <asp:BoundField DataField="var_licsevika_name" HeaderText="Name">
                                    <HeaderStyle Width="250px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="date_licsevika_birthdate" HeaderText="Birth Date" />
                                <asp:BoundField DataField="var_licsevika_address" HeaderText="Address">
                                    <HeaderStyle Width="230px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="num_licsevika_mobileno" HeaderText="Mobile No" />
                                <asp:BoundField DataField="var_angnwadimst_angncode" HeaderText="Anganwadi Code" />
                                <asp:BoundField DataField="var_licsevika_desigcode" HeaderText="Desigation" />
