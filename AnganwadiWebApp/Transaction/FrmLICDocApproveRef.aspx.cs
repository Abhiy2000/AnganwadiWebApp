...
{
    public partial class FrmLICDocApproveRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmLICDocApproveList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Sevika LIC Document Approval";                 //---- Label Heading : Master Name ---//
