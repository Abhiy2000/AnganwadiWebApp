<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPagePayDetails.Master"
    AutoEventWireup="true" CodeBehind="FrmPayDetailReport.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmPayDetailReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-top: 10px; margin-left: 275px;">
        <table class="style1">
            <tr>
                <td>
                    Enter Adhar Number
                ...
                <td colspan="3">
                    :&nbsp;<asp:TextBox runat="server" ID="txtAdharNumber" MaxLength="16" Width="275px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="3">
                    :&nbsp;<asp:TextBox runat="server" ID="txtConfirmAdharNumber" MaxLength="16" Width="275px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    :&nbsp;<asp:TextBox runat="server" ID="txtPayConfCaptcha" MaxLength="16" Width="275px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" style="margin-top:8px;    margin-left: 10px;" CssClass="Button" OnClick="btnSubmit_Click" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:Label runat="server" ID="Label1">:</asp:Label>&nbsp;<asp:TextBox runat="server"
                        ID="txtSavikaName" MaxLength="16" Width="275px"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>
