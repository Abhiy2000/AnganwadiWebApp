...
{
    public partial class FrmLICDocUploadRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmLICDocUploadList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Sevika LIC Document Upload";                 //---- Label Heading : Master Name ---//
