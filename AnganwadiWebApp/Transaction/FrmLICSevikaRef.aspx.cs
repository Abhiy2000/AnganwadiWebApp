...
{
    public partial class FrmLICSevikaRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmLICSevikaList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "LIC Sevika Master";                            //---- Label Heading : Master Name ---//
