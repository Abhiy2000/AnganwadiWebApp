...
{
    public partial class FrmSevikaAuthList : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {                
                ...
                if (ddlDivision.SelectedValue != "" && ddlDistrict.SelectedValue != "" && ddlCDPO.SelectedValue != "" && ddlBeat.SelectedValue != "")
                {
        ...
        protected void GrdSevikaList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Transaction/FrmSevikaAuthMst.aspx");
        }
        ...
        protected void LoadGrid()
        {
            ...
            Query += " c.var_education_educname,a.date_sevikamaster_birthdate, a.var_sevikamaster_address,a.num_sevikamaster_mobileno,CASE WHEN   var_sevikamaster_active ='Y' THEN 'Yes' ELSE 'No' END var_sevikamaster_active, ";
            ...
            Query += " where a.num_sevikamaster_compid='" + Session["GrdLevel"] + "' and var_sevikamaster_authorizedby is null and date_sevikamaster_authdate is null ";//;and num_sevikamaster_sevikaid=";
