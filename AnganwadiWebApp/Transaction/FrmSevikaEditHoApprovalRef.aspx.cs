...
{
    public partial class FrmSevikaEditHoApprovalRef : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String MenuRights = MstMethods.ChkRights(Session["UserId"].ToString(), "../Transaction/FrmSevikaEditHoApprovalRef.aspx");
            ...
            Session["BrToList"] = "../Transaction/FrmSevikaEditHoApproval.aspx";    //---- To Redirect Transaction MainList ---//
