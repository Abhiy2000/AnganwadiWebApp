<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmSevikaEdtListScrn.aspx.cs"
    Inherits="AnganwadiWebApp.Transaction.FrmSevikaEdtListScrn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="boxHead">
        <asp:Label ID="LblGrdHead" runat="server" Font-Size="Medium">Transaction >> Sevika Edit List </asp:Label>
    </div>
    <br />
    <div class="Panel" style="height: 580px; width: 100%; overflow: auto;">
        <table align="left" style="width: 100%;">
            ...
            <tr>
                <td></td>
                <td colspan="9">
                    <asp:Button runat="server" CssClass="Button" ID="BtnAddNew" Text="Add New" OnClick="BtnAddNew_Click" />
                </td>
            </tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="conditional" ChildrenAsTriggers="false">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridCdpoScrn" runat="server" AutoGenerateColumns="false" AllowPaging="true" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataText="No Records Found!" ShowHeaderWhenEmpty="true"
                            PageSize="10" CssClass="Grid" Width="100%" OnSelectedIndexChanged="GridCdpoScrn_SelectedIndexChanged" OnPageIndexChanging="GridCdpoScrn_PageIndexChanging" OnRowDataBound="GridCdpoScrn_RowDataBound">
                            <Columns>

                                <asp:BoundField DataField="sevikaedit_id" HeaderText="edit id" />
                                <asp:CommandField SelectText="Select" ShowSelectButton="true" HeaderStyle-Width="50px" HeaderText="Select" />
                                <asp:BoundField DataField="sevikaid" HeaderStyle-Width="80px" HeaderText="Sevika Id" />

                                <asp:BoundField DataField="sevikaname" HeaderStyle-Width="250px" HeaderText="Sevika Details" />
                                ...
                                <asp:TemplateField HeaderText="Doc.Download" HeaderStyle-Width="12%">
                                    <ItemTemplate>
                                        <p>
                                            DOB : 
                                        ...
                                        <p>
                                            Aadhar No.: 
                                            <asp:LinkButton ID="lnkDownloadAadhar" OnClick="lnkDownload_Click" runat="server" CommandArgument="Aadhar"></asp:LinkButton>
                                        </p>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Remark" Visible="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRemark" runat="server" Text='<%# Eval("cdpo_remark") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderStyle-Width="10%" ItemStyle-Width="10%" HeaderText="View" Visible="false">
                                    <ItemTemplate>
