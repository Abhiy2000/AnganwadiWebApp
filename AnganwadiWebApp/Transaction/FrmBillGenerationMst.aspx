<%@ Page Title="Bill Generation" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmBillGenerationMst.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmBillGenerationMst" %>
            ...
            <table align="left">
                <tr>
                    ...
                    <td style="width: 240px">
                        <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="DropDown" />
                    </td>
                </tr>
                <tr>
                    <td>Bill Date<span style="color: Red"> * </span>
                    </td>
                    <td style="width: 10px">:
                    </td>
                    <td>
