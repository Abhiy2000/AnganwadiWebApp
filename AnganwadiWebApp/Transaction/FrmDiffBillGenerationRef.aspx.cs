...
{
    public partial class FrmDiffBillGenerationRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmDiffBillGenerationMst.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + " Bill Generation";                 //---- Label Heading : Master Name ---//
