<%@ Page Title="Transfer of Sevika" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmSevikaTransfer.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmSevikaTransfer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Panel ID="PnlDropdowns" runat="server">
            <table>
                <tr id="trAadhar" runat="server">
                    <td style="width: 90px">
                        <span style="color: Red">*</span> Aadhar No
                    </td>
                    <td style="width: 10px">
                        :
                    </td>
        ...
        <asp:Panel ID="PnlDetail" runat="server">
            <fieldset>
                <legend style="font-size: large;">Current Information</legend>
                <table>
                    <tr>
                        <td style="width: 90px">
                            Name
            ...
            <br />
            <fieldset>
                <legend style="font-size: large">Transfer To</legend>
                <table>
                    <tr>
                        <td style="width: 90px">
                            Division
                    ...
                    <tr>
                        <td style="width: 90px">
                            <span style="color: Red">*</span> Anganwadi
                        </td>
                        <td style="width: 10px">
                            :
                        </td>
                        <td colspan="5">
                            <asp:DropDownList ID="ddlNewAnganwadi" runat="server" CssClass="DropDown" Width="550px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
