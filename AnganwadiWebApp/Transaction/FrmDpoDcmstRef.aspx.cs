...
{
    public partial class FrmDpoDcmstRef : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String MenuRights = MstMethods.ChkRights(Session["UserId"].ToString(), "../Transaction/FrmDpoDcmstRef.aspx");
            ...
            Session["BrToList"] = "../Transaction/FrmDpoDcmst.aspx";    //---- To Redirect Transaction MainList ---//
