<%@ Page Title="Monthly Attendence" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmMothlyAttendList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmMothlyAttendList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <hr />
            <asp:Button ID="btnNew" runat="server" Text="Enter New Attendance" CssClass="Button" OnClick="btnNew_Click" Width="150px" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table>
                <tr>
                    <td class="style1">
                        <asp:GridView ID="GrdAttendList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            OnSelectedIndexChanged="GrdAttendList_SelectedIndexChanged" OnRowDataBound="GrdAttendList_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="angnwdi" HeaderText="Anganwadi">
                                    <HeaderStyle Width="200px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="saldate" HeaderText="Salary Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                <asp:BoundField DataField="empcount" HeaderText="Employee Count">
                                    <HeaderStyle Width="250px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="prjid" HeaderText="Project type" />
                                <asp:BoundField DataField="angnid" HeaderText="AnganwdiId" />
                            </Columns>
