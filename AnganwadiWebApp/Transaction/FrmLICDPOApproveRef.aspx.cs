...
{
    public partial class FrmLICDPOApproveRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmLICDPOApproveList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "DPO LIC Document Approval";                 //---- Label Heading : Master Name ---//
