<%@ Page Title="Bill Generation" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmBillGenerationList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmBillGenerationList" %>
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            ...
            <table>
                <tr>
                    <td class="style1">
                        <asp:GridView ID="GrdBillGenList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            OnSelectedIndexChanged="GrdBillGenList_SelectedIndexChanged" OnRowDataBound="GrdBillGenList_RowDataBound">
                            <RowStyle CssClass="GrdRow"></RowStyle>
                            <Columns>
                                <asp:CommandField HeaderText="Select Bill" ShowSelectButton="True" SelectText="Select Bill">
