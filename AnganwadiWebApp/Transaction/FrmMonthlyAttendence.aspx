<%@ Page Title="Monthly Attendence" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmMonthlyAttendence.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmMonthlyAttendence" %>
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            ...
            <table>
                        ...
                        <asp:GridView ID="grdMonAttendance" runat="server"  AutoGenerateColumns="false" CssClass="Grid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Absent Days">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAbsentDays" runat="server" Width="80px" onchange="GetSelectedRow(this)"
                                            OnTextChanged="txtAbsentDays_TextChanged" AutoPostBack="true" ClientIDMode="Static" MaxLength="2"></asp:TextBox>
                                        <%--<asp:TextBox ID="TextBox1" runat="server" Width="80px" OnTextChanged="txtAbsentDays_TextChanged" 
                                ...
                                <asp:TemplateField HeaderText="LeaveFlag"  Visible="false">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblLeaveFlag" ClientIDMode="Static"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                ...
                <tr>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnInsert" runat="server" CssClass="Button" Text="Submit" Visible="false"
