<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPagePayDetail.Master"
    AutoEventWireup="true" CodeBehind="FrmCheckPaymentDetails.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmCheckPaymentDetails" %>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:Label runat="server" ID="Label1">:</asp:Label>&nbsp;<asp:TextBox runat="server"
                        ID="txtSavikaName" MaxLength="16" Width="260px"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>
