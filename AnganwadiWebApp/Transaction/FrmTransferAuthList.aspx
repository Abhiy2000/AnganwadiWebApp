<%@ Page Title="Transfer of Sevika" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmTransferAuthList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmTransferAuthList" %>
                        ...
                        <asp:GridView ID="GrdSevikaList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NewAngan" HeaderText="New Anganwadi">
                                 ...
                                 <asp:BoundField DataField="dat_transfer_transferdate" HeaderText="Transfer Date" DataFormatString="{0:dd-MMM-yyyy}">
                                </asp:BoundField>
                            </Columns>
