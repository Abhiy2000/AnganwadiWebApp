<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmLICDocUploadMst.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmLICDocUploadMst" %>
            ...
            <div class="active tab-pane" id="tab-1">
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtAngwadiName" CssClass="TextBox" runat="server" MaxLength="100" Width="230px" />
                        </td>
                    </tr>
                    <tr>
