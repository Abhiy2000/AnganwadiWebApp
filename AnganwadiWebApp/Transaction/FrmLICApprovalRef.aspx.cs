...
{
    public partial class FrmLICApprovalRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmLICApprovalList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Sevika LIC Approval List";                 //---- Label Heading : Master Name ---//
