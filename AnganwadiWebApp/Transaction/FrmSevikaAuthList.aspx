<%@ Page Title="Authorized Sevika" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmSevikaAuthList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmSevikaAuthList" %>
                ...
                <tr>
                    <td class="style1">
                        <asp:GridView ID="GrdSevikaList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            OnRowDataBound="GrdSevikaList_RowDataBound" OnSelectedIndexChanged="GrdSevikaList_SelectedIndexChanged">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="var_sevikamaster_active" HeaderText="Active" />
