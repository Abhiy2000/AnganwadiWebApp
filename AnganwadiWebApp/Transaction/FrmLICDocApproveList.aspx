<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmLICDocApproveList.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmLICDocApproveList" %>
        ...
        <asp:Panel ID="PnlSerch" runat="server" Style="height: 500px; width: 100%;">
            <div>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="conditional" ChildrenAsTriggers="false">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdLICDEF" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnRowDataBound="grdLICDEF_RowDataBound"
                            PageSize="10" CssClass="Grid" Width="60%" OnPageIndexChanging="grdLICDEF_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Download" HeaderStyle-Width="15%">
                                 ...
                                 <asp:TemplateField HeaderText="FlagType">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFlagType" runat="server" Text='<%#Bind("LicFlagType") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <div style="margin-left: 500px;">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="conditional">
                    <Triggers>
                        ...
                        <asp:PostBackTrigger ControlID="chkTerms" />
                    </Triggers>
                    <ContentTemplate>
