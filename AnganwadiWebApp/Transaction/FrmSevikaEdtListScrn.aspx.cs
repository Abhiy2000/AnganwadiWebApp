...
{
    public partial class FrmSevikaEdtListScrn : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void LoadGrid()
        {
            ...
            query += " num_sevikamaster_compid comp_id,var_docdob_type dob_type,var_docdoj_type doj_type,var_docaadhar_type aadhar_type, ";
            query += " (var_sevikaedit_cdporemark||' '||var_sevikaedit_dporemark||' '||var_dc_appremark||'  '||var_hoappr_remark) remarks  from aoup_sevikaedit  inner join  aoup_sevikamaster_def ";
        ...
        protected void GridCdpoScrn_SelectedIndexChanged(object sender, EventArgs e)
        {
            GridViewRow rw = GridCdpoScrn.SelectedRow;
            Session["SevikaEdtIdLst"] = rw.Cells[0].Text.Trim();

            Session["SevikaIdUpdt"] = rw.Cells[2].Text.Trim();
