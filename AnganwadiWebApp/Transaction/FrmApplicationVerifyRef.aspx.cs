...
{
    public partial class FrmApplicationVerifyRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmApplicationVerifyList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Application Verification List";                            //---- Label Heading : Master Name ---//
