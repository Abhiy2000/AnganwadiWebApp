<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmDpoDcmst.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmDpoDcmst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="boxHead">
        <asp:Label ID="LblGrdHead" runat="server" Font-Size="Medium">Transaction >> DPO/DC Screen </asp:Label>
    </div>
    <br />
                        ...
                        <asp:GridView ID="GridCdpoScrn" runat="server" AutoGenerateColumns="false" AllowPaging="true" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataText="No Records Found!"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Remark">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRemark" runat="server" Text='<%# Eval("dpo_remark") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderStyle-Width="10%" ItemStyle-Width="10%" HeaderText="Upload">
                                    <ItemTemplate>
                                        <asp:FileUpload runat="server" ID="flupldDpo" accept=".jpeg,.jpg,.png,.pdf" Width="79px"></asp:FileUpload>
                                    </ItemTemplate>
                                </asp:TemplateField>
