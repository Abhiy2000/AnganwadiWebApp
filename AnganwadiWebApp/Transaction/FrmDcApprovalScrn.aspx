<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FrmDcApprovalScrn.aspx.cs" Inherits="AnganwadiWebApp.Transaction.FrmDcApprovalScrn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="boxHead">
        <asp:Label ID="LblGrdHead" runat="server" Font-Size="Medium">Transaction >> DC Approval Screen </asp:Label>
    </div>
    <br />
        ...
        <asp:Panel ID="PnlSerch" runat="server" Style="height: 560px; width: 100%;">
            <div>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="conditional" ChildrenAsTriggers="false">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridCdpoScrn" runat="server" AutoGenerateColumns="false" AllowPaging="true" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataText="No Records Found!"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Existing">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <p>AadharNo:<asp:Label ID="lblOldAadharNo" runat="server" Text='<%# Eval("old_aadharno") %>' /></p>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Change">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <p>
                                            AadharNo:<asp:Label ID="lblNewAadharNo" runat="server" Text='<%# Eval("new_aadharno") %>' />
                                        </p>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Doc.Download" HeaderStyle-Width="10%">
                                    <ItemTemplate>
                                        <p>
                                            DOB:
                                ...
                                <asp:TemplateField HeaderText="Remark">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRemark" runat="server" Text='<%# Eval("dc_remark") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderStyle-Width="10%" ItemStyle-Width="10%" HeaderText="Upload">
                                    <ItemTemplate>
                                        <asp:FileUpload runat="server" ID="flupldDCdoc" accept=".jpeg,.jpg,.png,.pdf" Width="79px"></asp:FileUpload>
                                    </ItemTemplate>
                                </asp:TemplateField>
