...
{
    public partial class FrmMonthlyAttendenceAuthRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmMonthlyAttendenceAuthList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Monthly Attendence Authorisation";                 //---- Label Heading : Master Name ---//
