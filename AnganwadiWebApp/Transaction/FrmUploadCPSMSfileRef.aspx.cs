...
{
    public partial class FrmUploadCPSMSfileRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Transaction/FrmUploadCPSMSfile.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Transaction" + " >> " + "Upload PFMS Code ";                 //---- Label Heading : Master Name ---//
