<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmBITList.aspx.cs" Inherits="AnganwadiWebApp.MstListPages.FrmBITList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:GridView ID="GrdBITList" runat="server" Width="60%" CssClass="Grid" ShowFooter="True"
            AutoGenerateColumns="False" OnRowDataBound="GrdBITList_RowDataBound" OnSelectedIndexChanged="GrdBITList_SelectedIndexChanged">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Beat Id" DataField="BRID">
                    <HeaderStyle Width="80px" />
                </asp:BoundField>
                <asp:BoundField HeaderText="Beat Name" DataField="COMPANYNAME">
                    <HeaderStyle Width="330px" />
                </asp:BoundField>
                <asp:BoundField HeaderText="Beat Branch Name" DataField="BRANCHNAME">
                    <HeaderStyle Width="330px" />
                </asp:BoundField>
            </Columns>
