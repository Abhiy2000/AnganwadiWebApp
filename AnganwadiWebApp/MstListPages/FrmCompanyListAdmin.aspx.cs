...
{
    public partial class FrmCompanyListAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                String str = "select companyname, brid CompanyId from companyview where brcategory in (0, 1) order by companyname";
