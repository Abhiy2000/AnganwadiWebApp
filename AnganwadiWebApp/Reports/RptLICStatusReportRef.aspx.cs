...
{
    public partial class RptLICStatusReportRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptLICStatusReport.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Sevika LIC Status";  //---- Label Heading : Master Name ---//
