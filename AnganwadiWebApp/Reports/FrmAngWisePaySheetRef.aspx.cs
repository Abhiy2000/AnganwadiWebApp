...
{
    public partial class FrmAngWisePaySheetRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmAngWisePaySheetList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Pay sheet List";                 //---- Label Heading : Master Name ---//
