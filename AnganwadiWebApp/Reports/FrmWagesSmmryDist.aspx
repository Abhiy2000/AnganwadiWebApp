<%@ Page Title="Wages Summary Report" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmWagesSmmryDist.aspx.cs" Inherits="AnganwadiWebApp.Reports.FrmWagesSmmryDist" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdDistWgs" runat="server" CssClass="Grid" Width="90%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" ShowFooter="True" FooterStyle-BackColor="#428BCA" FooterStyle-Font-Bold="true"
                            FooterStyle-ForeColor="white" FooterStyle-HorizontalAlign="Right" OnRowDataBound="grdDistWgs_RowDataBound">
                            <FooterStyle BackColor="#428BCA" ForeColor="White" HorizontalAlign="Right" />
                            <RowStyle CssClass="GrdRow"></RowStyle>
                            <Columns>
                                <asp:TemplateField HeaderText="District" HeaderStyle-HorizontalAlign="Center" FooterText="Total">
                                    <HeaderStyle Width="270px" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDist" runat="server" Text='<%# Eval("distname") %>' OnClick="lnkDist_Click"></asp:LinkButton>
                                        <asp:HiddenField ID="hdndist" runat="server" Value='<%# Eval("distid").ToString()%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%-- <asp:BoundField DataField="" HeaderText="District">
                                    <HeaderStyle Width="150px" />
                                </asp:BoundField>--%>
                                <asp:BoundField DataField="distid" HeaderText="District ID" ItemStyle-HorizontalAlign="Right"
