...
{
    public partial class rptRetirementBenefitRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/rptRetirementBenefitList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Retirement Benefit Report";                 //---- Label Heading : Master Name ---//
