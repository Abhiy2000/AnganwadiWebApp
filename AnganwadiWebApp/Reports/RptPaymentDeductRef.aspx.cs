...
{
    public partial class RptPaymentDeductRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptPaymentDeductions.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "PPA File for Upload";                 //---- Label Heading : Master Name ---//
