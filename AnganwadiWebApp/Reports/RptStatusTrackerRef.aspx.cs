...
{
    public partial class RptStatusTrackerRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptStatusTracker.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Status Tracker";                 //---- Label Heading : Master Name ---//
