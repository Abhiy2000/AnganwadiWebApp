...
{
    public partial class FrmSevikaEdtReportScrnRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmSevikaEdtReportScrn.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Report >> Sevika Edit Report Status";                 //---- Label Heading : Master Name ---//
