<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmWagesSmmryAngan.aspx.cs" Inherits="AnganwadiWebApp.Reports.FrmWagesSmmryAngan" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdAnganWgs" runat="server" CssClass="Grid" Width="90%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" ShowFooter="True" FooterStyle-BackColor="#428BCA" FooterStyle-Font-Bold="true"
                            FooterStyle-ForeColor="white" FooterStyle-HorizontalAlign="Right" OnRowDataBound="grdAnganWgs_RowDataBound">
                            <FooterStyle BackColor="#428BCA" ForeColor="White" HorizontalAlign="Right" />
                            <RowStyle CssClass="GrdRow"></RowStyle>
                            <Columns>
                                <asp:BoundField DataField="anganName" HeaderText="Anganwadi" ItemStyle-HorizontalAlign="Left" FooterText="Total"
                                    HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle Width="270px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="anganid" HeaderText="Anganwadi ID" ItemStyle-HorizontalAlign="Right"
