<%@ Page Title="Retirement Report" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmRetirementRpt.aspx.cs" Inherits="AnganwadiWebApp.Reports.FrmRetirementRpt" %>
                    ...
                    <td class="style1">
                        <asp:GridView ID="GrdRetirement" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="JoiningAge" HeaderText="Joining Age"></asp:BoundField>
                                <asp:BoundField DataField="CurrentAge" HeaderText="Current Age"></asp:BoundField>
                                <asp:BoundField DataField="ServiceComplete" HeaderText="Service Complete"></asp:BoundField>
                                <asp:BoundField DataField="Service_Year" HeaderText="No. of Years of Service"></asp:BoundField>
                                <asp:BoundField DataField="RetirmentDate" HeaderText="Retirement Date" DataFormatString="{0:dd-MMM-yyyy}">
                                </asp:BoundField>
                            </Columns>
