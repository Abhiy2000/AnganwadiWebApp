<%@ Page Title="Base file for Bill" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="RptBankPayment.aspx.cs" Inherits="AnganwadiWebApp.Reports.RptBankPayment" %>
    ...
    <div class="Panel" style="width: 97%; height: 468px; overflow: auto;">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <table align="left" width="62%">
                <tr>
                    <td style="width: 55px">Salary Date
                    </td>
                    <td style="width: 10px">:
                    </td>
                    <td width="350px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;
                        <asp:RadioButton ID="rbdAll" runat="server" Text="All" GroupName="SevikaType" Visible="false" />
                    </td>
                </tr>
                <tr>
                    <td></td>
