...
{
    public partial class FrmPayDetailReportRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmPayDetailReport.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Pay Detail Report";                 //---- Label Heading : Master Name ---//
