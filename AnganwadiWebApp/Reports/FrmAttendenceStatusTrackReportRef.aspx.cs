...
{
    public partial class FrmAttendenceStatusTrackReportRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmAttendenceStatusTrackReport.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Attendence Status Tracker Report";                 //---- Label Heading : Master Name ---//
