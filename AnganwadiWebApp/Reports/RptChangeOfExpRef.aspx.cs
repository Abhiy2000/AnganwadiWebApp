...
{
    public partial class RptChangeOfExpRef : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptChangeOfExp.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Change Of Experience Report";                 //---- Label Heading : Master Name ---//
