...
{
    public partial class FrmRetirementRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmRetirementRpt.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Retirement Report";                 //---- Label Heading : Master Name ---//
