<%@ Page Title="Sevika List Report" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="RptSevikaListRpt.aspx.cs" Inherits="AnganwadiWebApp.Reports.RptSevikaListRpt" %>
        ...
        <asp:Panel ID="PnlDropdowns" runat="server">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButton ID="rbdAll" runat="server" GroupName="StatusType" Text="All" Checked="true"
                            AutoPostBack="true" />&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbdActive" runat="server" GroupName="StatusType" Text="Active"
                            AutoPostBack="true" />&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbdInactive" runat="server" GroupName="StatusType" Text="Inactive"
                            AutoPostBack="true" />
                    </td>
                </tr>
            </table>
