...
{
    public partial class RptMonthAttendRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptMonthlyAttendence.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Monthly Attendence Report";                 //---- Label Heading : Master Name ---//
