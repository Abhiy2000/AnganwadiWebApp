...
{
    public partial class RptSevikaTransferRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptSevikaTransfer.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Sevika Transfer Report";                 //---- Label Heading : Master Name ---//
