<%@ Page Title="Project Type Summary" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="ProjTypeSummaryRefList.aspx.cs" Inherits="AnganwadiWebApp.Reports.ProjTypeSummaryRefList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <div class="Panel" style="width: 185%; height: 468px; overflow: auto">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnExport" CssClass="Button" Text="Export" runat="server" Visible="false"
        ...
        <table>
            <tr>
                <td class="style1">
                    <asp:GridView ID="grdTypSummaryRpt" runat="server" CssClass="Grid" Width="70%" ShowFooter="True"
                        FooterStyle-BackColor="#428BCA" FooterStyle-ForeColor="white" AutoGenerateColumns="False"
                        FooterStyle-HorizontalAlign="Right">
                        <RowStyle CssClass="GrdRow"></RowStyle>
                        <Columns>
                            <asp:BoundField DataField="ProjectType" HeaderText="Project Type" FooterText="Total" Visible="false">
                            ...
                            <asp:BoundField DataField="TotalSalary" HeaderText="Total Salary" DataFormatString="{0:0}">
                                <ItemStyle HorizontalAlign="Right" />
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                        </Columns>
