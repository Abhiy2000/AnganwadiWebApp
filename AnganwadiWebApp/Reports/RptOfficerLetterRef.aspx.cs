...
{
    public partial class RptOfficerLetterRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptOfficerLetter.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Officer Letter";                 //---- Label Heading : Master Name ---//
