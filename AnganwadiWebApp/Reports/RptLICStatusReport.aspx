<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="RptLICStatusReport.aspx.cs" Inherits="AnganwadiWebApp.Reports.RptLICStatusReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="boxHead">
        <asp:Label ID="LblGrdHead" runat="server" Font-Size="Medium"> LIC Status Report </asp:Label>
    </div>
    <br />
    <div class="Panel" style="width: 97%; height: 500px; overflow: auto">
        <table align="left" cellpadding="20" cellspacing="20">
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rdbSevika" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
                        <asp:ListItem Text="External" style="margin-right: 20px" Value="E" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Internal" style="margin-right: 20px;" Value="I"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rdbExport" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="PDF" style="margin-right: 20px" Value="P" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Excel" style="margin-right: 20px;" Value="E"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
