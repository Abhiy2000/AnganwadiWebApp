...
{
    public partial class FrmAuditTrailRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmAuditTrail.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Audit Trail Report";                 //---- Label Heading : Master Name ---//
