...
{
    public partial class RptDiffAbstractReportRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptDiffAbstractReport.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Difference Abstract Report";                 //---- Label Heading : Master Name ---//
