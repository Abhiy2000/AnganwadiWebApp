...
{
    public partial class RptSevikaListRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptSevikaListRpt.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Sevika List Report";                 //---- Label Heading : Master Name ---//
