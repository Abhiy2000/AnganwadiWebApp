<%@ Page Title="Wages Summary Report" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmWagesSmmryBIT.aspx.cs" Inherits="AnganwadiWebApp.Reports.FrmWagesSmmryBIT" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdBITWgs" runat="server" CssClass="Grid" Width="90%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" ShowFooter="True" FooterStyle-BackColor="#428BCA" FooterStyle-Font-Bold="true"
                            FooterStyle-ForeColor="white" FooterStyle-HorizontalAlign="Right" OnRowDataBound="grdBITWgs_RowDataBound">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="CDPO" HeaderStyle-HorizontalAlign="Center" FooterText="Total">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkBIT" runat="server" Text='<%# Eval("bitbitname") %>' OnClick="lnkBIT_Click"></asp:LinkButton>
                                        <asp:HiddenField ID="hdnbit" runat="server" Value='<%# Eval("bitid").ToString()%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--<asp:BoundField DataField="bitbitname" HeaderText="BIT" ItemStyle-HorizontalAlign="Left" FooterText="Total"
                                    HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle Width="270px" />
                                </asp:BoundField>--%>
                                <asp:BoundField DataField="bitid" HeaderText="BIT ID" ItemStyle-HorizontalAlign="Right"
