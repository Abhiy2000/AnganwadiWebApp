...
{
    public partial class FrmMstSearchRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/FrmMstSearch.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "Master Search";                 //---- Label Heading : Master Name ---//
