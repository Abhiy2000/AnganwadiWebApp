...
{
    public partial class RptDiffPayment : System.Web.UI.Page
    {
        ...
        protected void LoadGrid()
        {
            ...
            Query += " nvl(num_salarydiff_diffcentral,0)   Centre_Share_Payment_Amount, ";
            ...
            Query += " nvl(num_salarydiff_diffstate,0)+nvl(num_salarydiff_difffixed,0)  State_Share_Payment_Amount, ";
            ...
            Query += " from  aoup_salarydiff_def d inner join aoup_sevikamaster_def a on ";
            Query += " a.num_sevikamaster_sevikaid= d.num_salarydiff_sevikaid ";//and a.num_sevikamaster_payscalid=d.num_salary_payscalid
            Query += " inner Join aoup_designation_def b on d.num_salarydiff_desigid=b.num_designation_desigid ";
            Query += " inner join corpinfo c on d.num_salarydiff_compid=c.bitid ";
            Query += " where stateid=" + TblGetHoId.Rows[0]["hoid"].ToString() + " and date_salarydiff_date = '" + lstdate + "' ";
            //Query += " and var_salarydiff_billnocentral is not null";
            Query += " and var_salarydiff_billnofixed is not null and var_salarydiff_billnocentral is not null and var_salarydiff_billnostate is not null ";
            ...
            {
                Query += " and var_sevikamaster_cpsmscode is not null and num_salarydiff_presentdays > 0 ";
            }
            if (rbdUnregistered.Checked == true)
            {
                Query += " and var_sevikamaster_cpsmscode is null and num_salarydiff_presentdays > 0 ";
            }
        ...
        public void BillNo()
        {
            ...
            billdet += " left join aoup_designation_def on num_designation_desigid=num_salarydiff_desigid ";
