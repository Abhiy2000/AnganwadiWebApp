<%@ Page Title="Abstract Report" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="rptAbstractReport.aspx.cs" Inherits="AnganwadiWebApp.Reports.rptAbstractReport" %>
            ...
            <table width="80%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;
                        <asp:RadioButton ID="rbd100" runat="server" Text="100%" GroupName="rptType" />
                    </td>
                </tr>
                 <tr>
                    <td>
