<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="RptDiffBankPayment.aspx.cs" Inherits="AnganwadiWebApp.Reports.RptDiffBankPayment" %>
    ...
    <div class="Panel" style="width: 97%; height: 468px; overflow: auto;">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 240px">
                        <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="DropDown" AutoPostBack="true" visible="false" />
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <table align="left" width="62%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbdNormal" runat="server" Text="Normal" GroupName="RptGrp" AutoPostBack="true"
                            Checked="true" Visible="false" />
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbdzeroPrsnt" runat="server" Text="Zero Present" GroupName="RptGrp"
                            AutoPostBack="true" Visible="false" />
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbdntReg" runat="server" Text="Not Registered" GroupName="RptGrp"
                            AutoPostBack="true" Visible="false" />
                    </td>
                </tr>
            </table>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="grdBillno" runat="server" AutoGenerateColumns="false" CssClass="Grid"
                                    ...
                                    <Columns>
                                        <asp:CommandField HeaderText="Download" ShowSelectButton="True" SelectText="Download">
            ...
            <table>
                <tr>
                    <td class="style1">
                        <asp:GridView ID="GrdBankPaymnt" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" OnSelectedIndexChanged="GrdBankPaymnt_SelectedIndexChanged"
                            OnRowDataBound="GrdBankPaymnt_RowDataBound" OnPageIndexChanging="GrdBankPaymnt_PageIndexChanging">
                            <RowStyle CssClass="GrdRow"></RowStyle>
                            <Columns>
                                ...
                                <asp:BoundField DataField="present" HeaderText="Present Days"></asp:BoundField>
                                <asp:BoundField DataField="absent" HeaderText="Absent Days"></asp:BoundField>
                                <asp:BoundField DataField="desg" HeaderText="Designation"></asp:BoundField>
                                <asp:BoundField DataField="centralShare" HeaderText="Centre Share Payment Amount">
                                </asp:BoundField>
                                <asp:BoundField DataField="StateShare" HeaderText="State Share Payment Amount"></asp:BoundField>
                                <asp:BoundField DataField="fixed" HeaderText="Fixed Payment Amount"></asp:BoundField>
                                <asp:BoundField DataField="finalAmt" HeaderText="Final Payment Amount"></asp:BoundField>
                                <asp:BoundField DataField="FrmDate" HeaderText="Payment From Date" DataFormatString="{0:dd-MMM-yyyy}">
                                </asp:BoundField>
                                <asp:BoundField DataField="ToDate" HeaderText="Payment To Date" DataFormatString="{0:dd-MMM-yyyy}">
                                </asp:BoundField>
                                <asp:BoundField DataField="Divisiion" HeaderText="Division"></asp:BoundField>
                                <asp:BoundField DataField="District" HeaderText="District"></asp:BoundField>
                                <asp:BoundField DataField="cdpo" HeaderText="CDPO Code"></asp:BoundField>
                                <asp:BoundField DataField="AWName" HeaderText="AWName"></asp:BoundField>
