...
{
    public partial class RptLICReportDownloadRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptLICReportDownload.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "LIC Report Download";                 //---- Label Heading : Master Name ---//
