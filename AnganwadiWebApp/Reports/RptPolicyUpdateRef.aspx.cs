...
{
    public partial class RptPolicyUpdateRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Reports/RptPolicyUpdateRpt.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Reports" + " >> " + "  ";                 //---- Label Heading : Master Name ---//
