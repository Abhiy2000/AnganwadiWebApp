<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmWagesSmmryDiv.aspx.cs" Inherits="AnganwadiWebApp.Reports.FrmWagesSmmryDiv" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <asp:Panel ID="Panel1" runat="server">
            <table>
                ...
                <tr>
                    ...
                    <td style="padding-left: 10px">
                        <asp:Button ID="Button1" runat="server" CssClass="Button" Text="Submit" OnClick="btnSubmit_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdDivWgs" runat="server" CssClass="Grid" Width="90%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" ShowFooter="True" FooterStyle-BackColor="#428BCA"
                            FooterStyle-Font-Bold="true" FooterStyle-ForeColor="white" FooterStyle-HorizontalAlign="Right"
                            OnRowDataBound="grdDivWgs_RowDataBound">
                            <FooterStyle BackColor="#428BCA" ForeColor="White" HorizontalAlign="Right" />
                            <RowStyle CssClass="GrdRow"></RowStyle>
                            <Columns>
                                <asp:TemplateField HeaderText="Division" HeaderStyle-HorizontalAlign="Center" FooterText="Total">
                                    <HeaderStyle Width="270px" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDiv" runat="server" Text='<%# Eval("divname") %>' OnClick="lnkDiv_Click"></asp:LinkButton>
                                        <asp:HiddenField ID="hdndiv" runat="server" Value='<%# Eval("divid").ToString()%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%-- <asp:BoundField DataField="" HeaderText="District">
                                    <HeaderStyle Width="150px" />
                                </asp:BoundField>--%>
                                <asp:BoundField DataField="divid" HeaderText="Division ID" ItemStyle-HorizontalAlign="Right"
