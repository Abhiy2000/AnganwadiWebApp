<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmDemotionList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmDemotionList" %>
      ...
      <div class="Panel">
        ...
        <div>
            ...
            <asp:GridView runat="server" AutoGenerateColumns="false" ID="grdList" AllowPaging="true"
                ...
                <Columns>
                    <asp:CommandField SelectText="Demotion" ShowSelectButton="true" HeaderText="Select" />
