...
{
    public partial class FrmRelationRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Master/FrmRelationList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Master" + " >> " + "Relation Master";                 //---- Label Heading : Master Name ---//
