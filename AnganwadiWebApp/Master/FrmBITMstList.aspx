<%@ Page Title="BIT Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmBITMstList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmBITMstList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <hr />
            <asp:Button ID="btnNew" runat="server" Text="Enter New BIT" CssClass="Button" OnClick="btnNew_Click"
                Width="150px" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdBITList" runat="server" CssClass="Grid" Width="80%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" OnSelectedIndexChanged="grdBITList_SelectedIndexChanged"
                            OnRowDataBound="grdBITList_RowDataBound" 
                            onpageindexchanging="grdBITList_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="corpid" HeaderText="BIT Id">
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Code" HeaderText="BIT Code">
                                    <HeaderStyle Width="180px" />
                                </asp:BoundField>
                                <%--<asp:BoundField DataField="Name" HeaderText="Company Name">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>--%>
                                <asp:BoundField DataField="Branch" HeaderText="BIT Name" ItemStyle-Wrap="false">
                                    <HeaderStyle Width="200px" />
                                </asp:BoundField>
