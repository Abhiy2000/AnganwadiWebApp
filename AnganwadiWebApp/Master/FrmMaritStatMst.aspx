<%@ Page Title="Marital Status Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmMaritStatMst.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmMaritStatMst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                <td>
                    <asp:Label ID="lblStatus" runat="server" Text="*" ForeColor="white" align="left"></asp:Label>Marital
                    Status
                </td>
                <td style="width: 10px">
                    :
                ...
                <td>
                    <asp:TextBox ID="txtStatus" runat="server" Width="200px" MaxLength="20" CssClass="TextBox"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                        FilterMode="ValidChars" TargetControlID="txtStatus" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ">
        ...
        <br />
        <br />
        <table width="190px" style="margin-left:100px">
            <tr>
                <td>
