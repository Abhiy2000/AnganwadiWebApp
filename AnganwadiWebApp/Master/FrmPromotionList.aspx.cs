...
{
    public partial class FrmPromotionList : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String MenuRights = MstMethods.ChkRights(Session["UserId"].ToString(), "../Master/FrmPromotionRef.aspx");
        ...
        protected void grdList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/master/FrmPromotionMst.aspx?@=2");
        }
        ...
        {
            Response.Redirect("~/master/FrmPromotionMst.aspx?@=1");
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (txtAdharNo.Text != "")
            {
                ...
                str += " WHERE  var_sevikamaster_aadharno = '" + txtAdharNo.Text + "' and var_payscal_active='Y' and var_designation_flag !='W' "; //H designation_flag H replacesd by W as per sachin sir's instructions   06/04/2023  //W designation_flag W replacesd by H as per sachin sir's instructions 
