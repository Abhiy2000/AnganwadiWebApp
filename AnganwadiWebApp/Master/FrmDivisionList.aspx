<%@ Page Title="Division Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmDivisionList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmDivisionList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New Division" CssClass="Button" OnClick="btnNew_Click" Width="150px" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table>
            <tr>
                <td>
                    <asp:GridView ID="grdDivisionList" runat="server" CssClass="Grid" Width="85%" AutoGenerateColumns="False"
                        OnSelectedIndexChanged="grdDivisionList_SelectedIndexChanged" OnRowDataBound="grdDivisionList_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="corpid" HeaderText="Division Id">
                                <HeaderStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Code" HeaderText="Division Code">
                                <HeaderStyle Width="180px" />
                            </asp:BoundField>
                            <%-- <asp:BoundField DataField="Name" HeaderText="Company Name">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>--%>
                            <asp:BoundField DataField="Branch" HeaderText="Division Name" ItemStyle-Wrap="false">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
