<%@ Page Title="Project Type Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmProjectTypeList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmProjectTypeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New Project Type" CssClass="Button" OnClick="btnNew_Click" Width="200px" />
        <hr />
        <table width="70%">
            <tr>
                <td class="style1">
                    <asp:GridView ID="GrdProjectList" runat="server" CssClass="Grid" Width="80%" AutoGenerateColumns="False"
                        OnRowDataBound="GrdProjectList_RowDataBound" OnSelectedIndexChanged="GrdProjectList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ProId" HeaderText="ProjectType Id">
                                <HeaderStyle Width="50px" />
                            </asp:BoundField>
