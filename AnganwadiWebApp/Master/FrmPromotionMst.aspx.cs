...
{
    public partial class FrmPromotionMst : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                String ddlEdu = "select var_education_educname, num_education_educid from aoup_education_def  where num_education_educid=" + Convert.ToInt32(Session["EduId"]) + " order by trim(var_education_educname) ";
        ...
        public void CallProc()
        {
            ...
            objPromotion.InsertPromotion();

            if (objPromotion.ErrorCode == -100)
            {
                MessageAlert(objPromotion.ErrorMessage, "../master/FrmPromotionList.aspx");
                return;
            }
            else
            {
