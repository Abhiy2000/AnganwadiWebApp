...
{
    public partial class FrmPayScaleRef : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Master/FrmPayScaleList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Master" + " >> " + "PayScale Master";                 //---- Label Heading : Master Name ---//
