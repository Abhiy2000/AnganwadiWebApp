<%@ Page Title="Category Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmCastMst.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmCastMst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                <td>
                    <asp:Label ID="lblCastName" runat="server" Text="*" ForeColor="white" align="left"></asp:Label>Category
                    Name
                </td>
                <td style="width: 10px">
                    :
                ...
                <td>
                    <asp:TextBox ID="txtCastName" runat="server" Width="200px" MaxLength="20" CssClass="TextBox"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                        FilterMode="ValidChars" TargetControlID="txtCastName" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ">
        ...
        <br />
        <br />
        <table width="170px" style="margin-left: 110px">
            <tr>
                <td>
