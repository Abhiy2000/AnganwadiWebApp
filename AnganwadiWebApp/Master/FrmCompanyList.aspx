<%@ Page Title="State Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmCompanyList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmCompanyList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New State" CssClass="Button" OnClick="btnNew_Click"
            Width="130px" />
        <hr />
        <table>
            <tr>
                <td>
                    <asp:GridView ID="grdStateList" runat="server" CssClass="Grid" Width="80%" AutoGenerateColumns="False"
                        OnSelectedIndexChanged="grdStateList_SelectedIndexChanged" OnRowDataBound="grdStateList_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="corpid" HeaderText="State Id">
                                <HeaderStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Code" HeaderText="State Code">
                                <HeaderStyle Width="80px" />
                            </asp:BoundField>
