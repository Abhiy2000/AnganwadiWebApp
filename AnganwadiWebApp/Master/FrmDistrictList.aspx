<%@ Page Title="District Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmDistrictList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmDistrictList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <hr />
            <asp:Button ID="btnNew" runat="server" Text="Enter New District" CssClass="Button" OnClick="btnNew_Click" Width="150px" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdDistrictList" runat="server" CssClass="Grid" Width="80%" 
                            AutoGenerateColumns="False" AllowPaging="true"
                        PageSize="10" OnSelectedIndexChanged="grdDistrictList_SelectedIndexChanged" 
                            OnRowDataBound="grdDistrictList_RowDataBound" 
                            onpageindexchanging="grdDistrictList_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="corpid" HeaderText="District Id">
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Code" HeaderText="District Code">
                                    <HeaderStyle Width="180px" />
                                </asp:BoundField>
                                <%--<asp:BoundField DataField="Name" HeaderText="Company Name">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>--%>
                                <asp:BoundField DataField="Branch" HeaderText="District Name" ItemStyle-Wrap="false">
                                    <HeaderStyle Width="200px" />
                                </asp:BoundField>
