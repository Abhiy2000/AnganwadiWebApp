<%@ Page Title="Retirement Age Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmRetirementAgeList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmRetirementAgeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New Retirement Age" CssClass="Button" OnClick="btnNew_Click" Width="250px" />
        <hr />
        <table width="80%">
            <tr>
                <td class="style1">
                    <asp:GridView ID="grdAgeList" runat="server" CssClass="Grid" Width="80%" AutoGenerateColumns="False"
                    AllowPaging="true" PageSize="10" 
                        OnSelectedIndexChanged="grdAgeList_SelectedIndexChanged" 
                        OnRowDataBound="grdAgeList_RowDataBound" 
                        onpageindexchanging="grdAgeList_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ageid" HeaderText="Age Id">
                                <HeaderStyle Width="40px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="age" HeaderText="Retirement Age">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="desg" HeaderText="Designation">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="AffDt" HeaderText="Affect From Date" DataFormatString="{0:dd-MMM-yyyy}">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
