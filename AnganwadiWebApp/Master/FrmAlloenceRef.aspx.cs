...
{
    public partial class FrmAlloenceRef : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Master/FrmAllowenceList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Master" + " >> " + "Allowance Master";                 //---- Label Heading : Master Name ---//
