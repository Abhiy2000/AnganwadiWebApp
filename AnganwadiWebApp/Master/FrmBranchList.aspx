<%@ Page Title="Bank Branch List" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmBranchList.aspx.cs" Inherits="AnganwadiLib.Masters.FrmBranchList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 97%; height: 468px; overflow: auto;">
        <table align="left" cellspacing="5px">
            <tr>
                <td>
                    <asp:Button ID="btnAdd" Text="Enter New Branch" OnClick="btnAdd_Click" runat="server"
        ...
        <table align="left" width="70%">
            <tr>
                <td>
                    <asp:GridView ID="grdBranchList" runat="server" AlternatingRowStyle-CssClass="GrdAltRow"
                        Width="80%" AutoGenerateColumns="false" CssClass="Grid" OnSelectedIndexChanged="grdBranchList_SelectedIndexChanged"
                        AllowPaging="True" PageSize="8" OnPageIndexChanging="grdBranchList_PageIndexChanging"
                        OnRowDataBound="grdBranchList_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="branchid" HeaderText="Branch Id" HeaderStyle-Width="80px" />
                            <asp:BoundField DataField="branchname" HeaderText="Branch Name" />
                            <asp:BoundField DataField="ifsccode" HeaderText="IFSC Code" HeaderStyle-Width="100px" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
