<%@ Page Title="Designation Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmDesignationList.aspx.cs" Inherits="ProjectManagement.Master.FrmDesignationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New Designation" CssClass="Button" OnClick="btnNew_Click" Width="200px" />
        <hr />
        <table>
            <tr>
                <td class="style1">
                    <asp:GridView ID="GrdDesignationList" runat="server" CssClass="Grid" Width="100%"
                        AutoGenerateColumns="False" OnRowDataBound="GrdDesignationList_RowDataBound"
                        OnSelectedIndexChanged="GrdDesignationList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="num_designation_desigid" HeaderText="Designation Id">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="var_designation_desig" HeaderText="Designation">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="var_designation_code" HeaderText="Code">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                        </Columns>
