...
{
    public partial class FrmBITRef : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Master/FrmBITMstList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Master" + " >> " + "BIT Master";                 //---- Label Heading : Master Name ---//
            ...
            {
                MessageAlert("Only Admin, ESSAdmin & ICDSAdmin Level user can Access this page", "");
            }
