...
{
    public partial class FrmAdditionalPayRef : System.Web.UI.Page
    {
        #region "MeesageAlert"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["BrToList"] = "../Master/FrmAdditionalPayList.aspx";    //---- To Redirect Master MainList ---//
            Session["LblGrdHead"] = "Master" + " >> " + "Additional Pay List";                 //---- Label Heading : Master Name ---//
