<%@ Page Title="Relation Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmRelationMst.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmRelationMst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                <td>
                    <asp:Label ID="lblRelName" runat="server" Text="*" ForeColor="white" align="left"></asp:Label>Relation
                    Name
                </td>
                <td style="width: 10px">
                    :
                ...
                <td>
                    <asp:TextBox ID="txtRelName" runat="server" Width="200px" MaxLength="20" CssClass="TextBox"></asp:TextBox>
                     <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                        FilterMode="ValidChars" TargetControlID="txtRelName" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ">
        ...
        <br />
        <br />
        <table width="200px" style="margin-left:105px">
            <tr>
                <td>
