<%@ Page Title="Bank Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmBankMaster.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmBankMaster" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBankCode" CssClass="TextBox" runat="server" MaxLength="50" Visible="false" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtBankName" CssClass="TextBox" runat="server" MaxLength="50" />
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                        FilterMode="ValidChars" TargetControlID="txtBankName" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ">
        ...
        <br />
        <br />
        <table width="180px" style="margin-left:90px">
            <tr>
                <td>
