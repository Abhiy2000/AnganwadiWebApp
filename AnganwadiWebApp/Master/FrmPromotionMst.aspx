<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmPromotionMst.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmPromotionMst" %>
            ...
            <table class="style1">
                ...
                <tr>
                    <td style="padding-bottom: 10px; padding-top: 10px;">
                        <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Maroon">Promotion</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td colspan="1">
                        :&nbsp;&nbsp;
                        <asp:TextBox CssClass="TextBox" runat="server" ID="txtExp" Width="205px" ReadOnly="true"></asp:TextBox>
                        <asp:DropDownList ID="ddlExperience" runat="server" CssClass="DropDown" AutoPostBack="true"  Width="205px"
                          Visible="false" OnSelectedIndexChanged="ddlExperience_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="1">
                        :&nbsp; &nbsp;
                         <asp:TextBox CssClass="TextBox" runat="server" ID="txtQuali" Width="205px" ReadOnly="true"></asp:TextBox>
                         <asp:DropDownList ID="ddlEduID" runat="server" CssClass="DropDown" Width="205px"
                          Visible="false"  AutoPostBack="true" OnSelectedIndexChanged="ddlEduID_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td>
                        &nbsp;
