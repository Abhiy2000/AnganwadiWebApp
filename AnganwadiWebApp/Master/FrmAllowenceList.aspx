<%@ Page Title="Allowance Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmAllowenceList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmAllowenceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New Allowance" CssClass="Button" OnClick="btnNew_Click" Width="150px" />
        <hr />
        <table width="100%">
            <tr>
                <td class="style1">
                    <asp:GridView ID="grdAllowList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                        OnSelectedIndexChanged="grdAllowList_SelectedIndexChanged" OnRowDataBound="grdAllowList_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="prjid" HeaderText="Project Id">
                                <HeaderStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="desgid" HeaderText="Designation Id">
                                <HeaderStyle Width="120px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="eduid" HeaderText="Education Id">
                                <HeaderStyle Width="120px" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="allowname" HeaderText="Allowance Name">
