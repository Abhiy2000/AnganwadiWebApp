<%@ Page Title="Religion Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmReligionMst.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmReligionMst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                <td>
                    <asp:Label ID="lblRelName" runat="server" Text="*" ForeColor="white" align="left"></asp:Label>Religion
                    Name
                </td>
                <td style="width: 10px">
                    :
                ...
                <td>
                    <asp:TextBox ID="txtRelName" runat="server" Width="200px" MaxLength="30" CssClass="TextBox"></asp:TextBox>
