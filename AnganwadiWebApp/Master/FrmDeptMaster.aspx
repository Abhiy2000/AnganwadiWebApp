<%@ Page Title="Department Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmDeptMaster.aspx.cs" Inherits="ProjectManagement.Master.FrmDeptMaster" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDepartmentCode" CssClass="TextBox" runat="server" MaxLength="50"
                        Visible="false" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDepartmentName" CssClass="TextBox" runat="server" MaxLength="50" />
                     <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                        FilterMode="ValidChars" TargetControlID="txtDepartmentName" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ">
        ...
        <br />
        <br />
        <table width="220px" style="margin-left:130px">
            <tr>
                <td>
