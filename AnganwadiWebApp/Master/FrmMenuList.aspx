<%@ Page Title="Menu List" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmMenuList.aspx.cs" Inherits="ProjectManagement.Master.FrmMenuList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <table>
            <tr>
                <td class="style1">
                    <asp:GridView ID="GrdMenuList" runat="server" CssClass="Grid" Width="100%" AutoGenerateColumns="False"
                        OnRowDataBound="GrdMenuList_RowDataBound" OnSelectedIndexChanged="GrdMenuList_SelectedIndexChanged">
                        <RowStyle CssClass="GrdRow"></RowStyle>
                        <Columns>
                            <asp:CommandField HeaderText="Modify" ShowSelectButton="True" SelectText="Modify">
                                <HeaderStyle Width="60px" />
                            </asp:CommandField>
                            <asp:BoundField DataField="menutitle" HeaderText="Menu Title">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="parent" HeaderText="Parent">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="pagepath" HeaderText="Page Path" />
                            <asp:BoundField DataField="menuid" HeaderText="MenuId">
                                <HeaderStyle Width="50px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="parentid" HeaderText="PMenuId">
                                <HeaderStyle Width="50px" />
                            </asp:BoundField>
                        </Columns>
