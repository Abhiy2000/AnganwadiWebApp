<%@ Page Title="Designation Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmDesignationMaster.aspx.cs" Inherits="ProjectManagement.Master.FrmDesignationMaster" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDesignationCode" CssClass="TextBox" runat="server" MaxLength="50"
                        Visible="false" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDesignationName" CssClass="TextBox" runat="server" MaxLength="50" />
                </td>
            </tr>
            <tr>
                <td>    
                ...
                <td>
                    <asp:RadioButton ID="rbdWorker" runat="server" Text="Anganwadi Worker" GroupName="desgFlag" />
                    &nbsp;&nbsp;
                    <asp:RadioButton ID="rbdHelper" runat="server" Text="Anganwadi Hepler" GroupName="desgFlag" />
                    &nbsp;&nbsp;
                    <asp:RadioButton ID="rbdOther" runat="server" Text="Anganwadi Other" GroupName="desgFlag" />
                    &nbsp;&nbsp;
                    <asp:RadioButton ID="rbdMini" runat="server" Text="Mini Anganwadi" GroupName="desgFlag" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtCode" CssClass="TextBox" runat="server" MaxLength="20" Visible="false" />
                </td>
            </tr>
        </table>
        <br />
