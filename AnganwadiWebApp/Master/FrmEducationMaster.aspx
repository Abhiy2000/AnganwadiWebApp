<%@ Page Title="Qualification Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmEducationMaster.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmEducationMaster" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table align="left">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEducationCode" CssClass="TextBox" runat="server" MaxLength="50"
                        Visible="false" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEducationName" CssClass="TextBox" runat="server" MaxLength="50" />
                </td>
            </tr>
        </table>
        <br />
        <br />
        <br />
        <table width="230px" style="margin-left:135px">
            <tr>
                <td>
