<%@ Page Title="CDPO Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmCDPOMstList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmCDPOMstList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        ...
        <asp:Panel ID="PnlSerch" runat="server">
            <hr />
            <asp:Button ID="btnNew" runat="server" Text="Enter New CDPO " CssClass="Button" OnClick="btnNew_Click"
                Width="150px" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="grdCDPOList" runat="server" CssClass="Grid" Width="80%" AutoGenerateColumns="False"
                            AllowPaging="true" PageSize="10" OnSelectedIndexChanged="grdCDPOList_SelectedIndexChanged"
                            OnRowDataBound="grdCDPOList_RowDataBound" OnPageIndexChanging="grdCDPOList_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="corpid" HeaderText="CDPO Id">
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Code" HeaderText="CDPO Code">
                                    <HeaderStyle Width="180px" />
                                </asp:BoundField>
                                <%--<asp:BoundField DataField="Name" HeaderText="Company Name">
                                <HeaderStyle Width="200px" />
                            </asp:BoundField>--%>
                                <asp:BoundField DataField="Branch" HeaderText="CDPO Name" ItemStyle-Wrap="false">
                                    <HeaderStyle Width="200px" />
                                </asp:BoundField>
