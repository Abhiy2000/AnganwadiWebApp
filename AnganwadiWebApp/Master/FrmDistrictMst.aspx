<%@ Page Title="District Master" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="FrmDistrictMst.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmDistrictMst" %>
    ...
    <div class="Panel" style="width: 100%; height: 490px; overflow: auto">
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlstate" runat="server" CssClass="DropDown" AutoPostBack="true"
                        Visible="false" OnSelectedIndexChanged="ddlstate_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td style="width: 100px">
                ...
                <td>
                    <asp:DropDownList ID="ddlDiv" runat="server" CssClass="DropDown" Visible="false"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCode" runat="server" CssClass="TextBox" MaxLength="3"></asp:TextBox>
            ...
            <tr>
                <td>
                    District DDO Code <span style="color: Red">* </span>
                </td>
                <td>
                    :
                </td>
                <td>
                    <asp:TextBox ID="txtDistCode" runat="server" CssClass="TextBox" MaxLength="10"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                        FilterMode="ValidChars" TargetControlID="txtDistCode" ValidChars="0123456789">
                    </ajaxToolkit:FilteredTextBoxExtender>
                </td>
            </tr>
            <tr>
