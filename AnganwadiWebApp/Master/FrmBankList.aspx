<%@ Page Title="Bank List" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FrmBankList.aspx.cs" Inherits="AnganwadiWebApp.Master.FrmBankList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Panel" style="width: 100%; height: 468px; overflow: auto">
        <asp:Button ID="btnNew" runat="server" Text="Enter New Bank" CssClass="Button" OnClick="btnNew_Click" Width="150px" />
        <hr />
        <table width="80%">
            <tr>
                <td class="style1">
                    <asp:GridView ID="GrdBankList" runat="server" CssClass="Grid" Width="80%" AutoGenerateColumns="False"
                        AllowPaging="true" OnRowDataBound="GrdBankList_RowDataBound" OnPageIndexChanging="GrdBankList_PageIndexChanging"
                        PageSize="10" OnSelectedIndexChanged="GrdBankList_SelectedIndexChanged1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="var_bank_bankname" HeaderText="Bank">
